...
def main():
  ...
  rnnmodel(args.num_epoches, args.lr, args.fc_n, args.fc_stride, args.fc_start, args.train_len, args.hidden_dim, args.dropout, args.batch_size, args.max_lag)


def rnnmodel(e, lr, fcn, fcsrd, fcsrt, tl, hdd, d, b, ml):
  ...
  df, series = dataset(r'C:\Users\91843\Downloads\Cat62data_train.csv')
